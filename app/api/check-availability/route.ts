...
async function checkCampingAvailability(date: string) {
  try {
    ...
    const reservePageUrl = process.env.NEXT_PUBLIC_CAMPING_URL || 'https://asp.hotel-story.ne.jp/ver3d/di/?hcod1=08300&hcod2=001&seek=on&def=seek';
    ...
    // 日付を含む要素を探す
    let dateElements = $(`*:contains("${formattedDate}")`);
    ...
    return {
      ...
      date,
      url: process.env.NEXT_PUBLIC_CAMPING_URL || 'https://asp.hotel-story.ne.jp/ver3d/di/?hcod1=08300&hcod2=001&seek=on&def=seek'
    };
  }
}
